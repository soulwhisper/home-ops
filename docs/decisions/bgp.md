...
```yaml
---
# yaml-language-server: $schema=https://soulwhisper.github.io/k8s-schemas/frrk8s.metallb.io/frrconfiguration_v1beta1.json
...
```yaml
---
# yaml-language-server: $schema=https://soulwhisper.github.io/k8s-schemas/cilium.io/ciliumbgpadvertisement_v2.json
  ...
  advertisements:
    ...
    - advertisementType: Service
      ...
      selector:
        matchExpressions:
          - {
              key: config.home-ops.io/bgp,
              operator: NotIn,
              values: ["disabled"],
            }
---
# yaml-language-server: $schema=https://soulwhisper.github.io/k8s-schemas/cilium.io/ciliumbgpclusterconfig_v2.json
apiVersion: cilium.io/v2
      ...
      peers:
        - name: cilium-bird2-nodelocal
          ...
          peerConfigRef:
            name: cilium-bird2-nodelocal
---
# yaml-language-server: $schema=https://soulwhisper.github.io/k8s-schemas/cilium.io/ciliumbgppeerconfig_v2.json
apiVersion: cilium.io/v2
