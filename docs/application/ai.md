...
- **Egress**: CiliumNetworkPolicy — agentgateway-proxy:80, hermes-agent:8642, virtualmcp:4483, open-webui-terminals:3000, open-webui-oikb:8080, postgres-rw:5432, open-webui-dragonfly:6379, ceph RGW:80, kube-dns, world-except-private (RAG web fetching)
